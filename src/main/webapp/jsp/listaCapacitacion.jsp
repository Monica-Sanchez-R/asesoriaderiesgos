...
<body>
  ...
  <h2 class="title_h2">Lista de Capacitaciones</h2>
  ...
  <div class="d-flex justify-content-center align-items-center p-3">
    ...
    <form id="login-form" class="formulario">
      ...
      <table>
        ...
        <tr>
          <td class="busqueda">Nombre de la Capacitacion:</td>
          <td class="respuesta"><%=request.getParameter("nombre")%></td>
        </tr>
        <tr>
          <td class="busqueda">Detalles:</td>
          <td class="respuesta"><%=request.getParameter("detalle")%></td>
        </tr>
        <tr>
          <td class="busqueda">Cantidad de participantes:</td>
          <td class="respuesta"><%=request.getParameter("cantidad")%></td>
        </tr>
      </table>
